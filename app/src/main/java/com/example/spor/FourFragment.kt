...
class FourFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        imageView.setImageResource(R.drawable.mide)
        ...
        recyclerView.adapter = MyRecyclerViewAdapter(generateData()) { position ->
            ...
            val fragment = DayDetailFragment4.newInstance(selectedDay)
        ...
        val divider: DividerItemDecoration = DividerItemDecoration(
            recyclerView.context,
            LinearLayoutManager.VERTICAL
        )
        // Divider'ın drawable'ını belirleyin (opsiyonel)
        val drawable: Drawable? = context?.getDrawable(R.drawable.horizontal_divider)
        drawable?.let {
